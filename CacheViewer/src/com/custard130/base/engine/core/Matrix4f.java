...
public class Matrix4f {
	...
	public Matrix4f initRotation(Quaternion q) {
		return initRotation(q.getForward(), q.getUp(), q.getRight());
	}

	public Matrix4f initRotation(Vector3f forward, Vector3f up, Vector3f right) {
		Vector3f f = (Vector3f) forward;
	...
	public Vector3f transform(Vector3f r) {
		float xr = m[0][0] * r.getX() + m[0][1] * r.getY() + m[0][2] * r.getZ() + m[0][3];
		float yr = m[1][0] * r.getX() + m[1][1] * r.getY() + m[1][2] * r.getZ() + m[1][3];
		float zr = m[2][0] * r.getX() + m[2][1] * r.getY() + m[2][2] * r.getZ() + m[2][3];
